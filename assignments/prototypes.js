...
/*
//base constructor - Parent constructor
...
*/
function CharacterStats(SonAttributes) {
  GameObject.call(this, SonAttributes);
...
function Humanoid(GSattributes) {
  CharacterStats.call(this, GSattributes);
...
Hero.prototype.stab = function(obj) {
  if (obj.healthPoints <= 1) {
    return obj.destroy();
  } else {
    return --obj.healthPoints;
